...
The Warden AIDLC Security Review Action supports custom security scan instructions, allowing you to add organization-specific vulnerability categories to the security audit.
